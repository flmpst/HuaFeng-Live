...
?>
    <div class="mdui-dialog custom-dialog" id="user">
        <div class="mdui-dialog-title mdui-color-grey-800">登录/注册 <span id="user-auth-msg"></span></div>
        <form class="mdui-dialog-content" id="user-form">
            <div class="cf-turnstile" data-sitekey="<?= $appConfig->cloudflare['turnstile']['siteKey'] ?>"></div>
        ...
        <div class="mdui-dialog-actions">
            ...
            <button class="mdui-btn mdui-btn-raised mdui-ripple" id="user-auth-btn">登录/注册</button>
        </div>
    </div>

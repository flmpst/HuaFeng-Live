...
--
-- 主机： localhost
-- 生成日期： 2025-07-10 08:24:23
-- 服务器版本： 8.3.0
-- PHP 版本： 8.2.18

--
-- huafeng_live 2.6.0.0
--
...
CREATE TABLE `messages` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT 'active',
  `danmaku` text COLLATE utf8mb4_bin COMMENT '弹幕参数'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- --------------------------------------------------------

--
-- 表的结构 `third_party_apps`
--
...
CREATE TABLE `third_party_apps` (
  ...
  `redirect_uri` varchar(255) DEFAULT NULL COMMENT 'OAuth回调地址',
  `created_at` datetime NOT NULL COMMENT '创建时间',
  `updated_at` datetime NOT NULL COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='第三方应用信息表';
...
--
-- 使用表AUTO_INCREMENT `third_party_apps`
--
ALTER TABLE `third_party_apps`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

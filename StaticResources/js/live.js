    ...
    try {
        ...
        // 检查是否支持 FLV 格式
            ...
            flvPlayer.play().catch(error => {
                ...
                document.getElementById('error-msg').innerHTML = '<p class="error-msg mdui-color-red-a700">播放失败，请重试。<br>' + error + '</p>';
            });
        ...
        // 检查是否支持 MP4 格式
            ...
            videoElement.play().catch(error => {
                console.error("播放错误:", error);
                document.getElementById('error-msg').innerHTML = '<p class="error-msg mdui-color-red-a700">视频加载失败，请重试。<br>' + error + '</p>';
            });
